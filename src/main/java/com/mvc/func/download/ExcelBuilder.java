...
public class ExcelBuilder extends AbstractExcelView {
    ...
    throws Exception {
		response.setContentType("application/octet-stream");//让浏览器显示下载对话框，而不是直接打开
		//response.setContentType("application/msexcel;charset=GBK");
		response.setHeader("Content-Disposition", "attachment;filename="+URLEncoder.encode("下载文件.xls","UTF-8"));
